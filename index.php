    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(src/assets/images/big/3.jpg);">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="src/assets/images/" alt="wrapkit">
                        </div>
                        ...
                        <form class="mt-4" method="post" action="connexion.php">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn w-100 btn-dark">Se connecter</button>
                                </div>
