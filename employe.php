...
if (isset($_POST['enregistrer'])) {
    if (isset($_POST['nom'], $_POST['prenom'], $_POST['telephone'], $_POST['adresse'],$_POST['specialite']));
    $req = $bd->prepare('INSERT into employe(nom,prenom,telephone,adresse,specialite) values(?,?,?,?,?)');
    $req->bindValue(1, $_POST['nom']);
    $req->bindValue(2, $_POST['prenom']);
    $req->bindValue(3, $_POST['telephone']);
    $req->bindValue(4, $_POST['adresse']);
    $req->bindValue(5, $_POST['specialite']);
    $req->execute();
    header('Location:employe_liste.php');

    // EDITION
if (isset($_GET['idm'])) {
    $req = $bd->query('SELECT * from employe where idEmploye=' . $_GET['idm']);
    if ($ligne = $req->fetch()) {
        $_POST['idEmploye'] = $ligne['idEmploye'];
        $_POST['nom'] = $ligne['nom'];
...
if (isset($_POST['modifier'])) {
    if (isset($_POST['nom'], $_POST['prenom'], $_POST['telephone'], $_POST['adresse'], $_POST['specialite']));
    $req = $bd->query('UPDATE employe set  nom=?,prenom=?telephone=?,adresse=?,specialite=? where idEmploye=?');
    $req->bindValue(1, $_POST['nom']);
    $req->bindValue(2, $_POST['prenom']);
    $req->bindValue(3, $_POST['telephone']);
    $req->bindValue(4, $_POST['adresse']);
    $req->bindValue(5, $_POST['specialite']);
    $req->bindValue(6, $_POST['idEmploye']);
    $req->execute();
...
<head>
    ...
    <title>Formulaire_Employe</title>
        ...
        <div>
            ...
            <div>
                ...
                <select name="specialite" id="">
                    <option><?php if (isset($_POST['specialite'])) echo $_POST['specialite'] ?></option>
            ...
            <div >
                <label for="">&nbsp;</label>
                <input class="bouton" type="submit" value="Enregistrer" name="enregistrer">
            </div>
            <?php }?>
        </form>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Employe</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Formulaires</a>
                                    </li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Employe</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Formulaire Employe</h4>
                                <form class="mt-4" action="employe.php" method="post">
                                    ...
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <select name="specialite" class="form-select" id="inputGroupSelect01">
                                            <option><?php if (isset($_POST['specialite'])) echo $_POST['specialite'] ?>
                                            </option>
                                            <option value="Couturier">Couturier</option>
                                            <option value="Styliste">Styliste</option>
                                            <option value="Designer">Designer</option>
                            ...
                            <?php { ?>
                            <div class="form-group" style="margin-top: 1rem;">
                                <input type="submit" class="btn waves-effect waves-light btn-rounded btn-primary"
