...
if (isset($_POST['enregistrer'])) {
    if (isset($_POST['nomC'], $_POST['prenomC'],$_POST['telephone'] ,$_POST['adresse']));
    $req = $bd->prepare('insert into client(nomC,prenomC,telephone,adresse) values(?,?,?,?)');
    $req->bindValue(1, $_POST['nomC']);
    $req->bindValue(2, $_POST['prenomC']);
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Formulaire Client</h4>
                                <form class="mt-4" action="client_form.php" method="post">
                                    <div class="form-group">
                                        <input name="nomC" type="text" class="form-control" placeholder=" Nom"
                                            value="<?php if (isset($_POST['nomC'])) echo $_POST['nomC'] ?>">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="prenomC" type="text" class="form-control" placeholder=" Prenom"
                                            value="<?php if (isset($_POST['prenomC'])) echo $_POST['prenomC'] ?>">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
            ...
            <footer class="footer text-center text-muted">
                  @MATHICOUTURE Tout Droit reserve.<a
                    href="https://MATHICOUTURE.com/"></a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
