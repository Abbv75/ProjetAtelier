...
if (isset($_POST['enregistrer'])) {
    if (isset($_POST['idFournisseur'], $_POST['nbrTissu'], $_POST['nbrBouton'], $_POST['nbrFils'], $_POST['autre']))
        ;
    $query = $bd->prepare('INSERT into stock (idFournisseur, nbrTissu,nbrBouton,nbrFils,autre) VALUES (?,?,?,?,?)');
    $query->execute([
        $_POST['idFournisseur'],
        $_POST['nbrTissu'],
        $_POST['nbrBouton'],
    ...
    echo
        "<script>
            ...
            document.location.href='stock_liste.php';
...
// EDITION
if (isset($_GET['idm'])) {
    $req = $bd->query('SELECT * from stock where idStock=' . $_GET['idm']);
    if ($ligne = $req->fetch()) {
        $_POST['idStock'] = $ligne['idStock'];
        $_POST['idFournisseur'] = $ligne['idFournisseur'];
        $_POST['nbrTissu'] = $ligne['nbrTissu'];
        $_POST['nbrBouton'] = $ligne['nbrBouton'];
        $_POST['nbrFils'] = $ligne['nbrFils'];
        $_POST['autre'] = $ligne['autre'];
...
if (isset($_POST['modifier'])) {
    if (isset($_POST['idFournisseur'], $_POST['nbrTissu'], $_POST['nbrBouton'], $_POST['nbrFils'], $_POST['autre']))
        ;
    $query = "UPDATE stock set idFournisseur=?,nbrTissu=?,nbrBouton=?,nbrFils=?,autre=? where idStock=?";
    // mysqli_query($bd, $query);
    $query = $bd->prepare("UPDATE stock set idFournisseur=?, nbrTissu=?, nbrBouton=?, nbrFils=?, autre=? where idStock=?");

    $query->execute([
        $_POST['idFournisseur'], $_POST['nbrTissu'], $_POST['nbrBouton'], $_POST['nbrFils'], $_POST['autre'], $_POST['idStock']
    ]);
    echo
        "<script>
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="deconnexion.php"
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Formulaire Stock</h4>
                                <form class="mt-4" action="stock.php" method="post">
                                    <?php
                                    if (isset($_GET['idm'])) {
                                        ?>
                                        <input type="hidden" name="idStock" value="<?= $_GET['idm'] ?>">
                                        <?php
                                    }
                                    ?>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <select name="idFournisseur" class="form-select" id="inputGroupSelect01">
                                            <?php
                                            $req = $bd->query('SELECT * FROM fournisseur');

                                            while ($ligne = $req->fetch()) {
                                                if (isset($_POST['idFournisseur']) && $ligne['idFournisseur'] == $_POST['idFournisseur']) {
                                                    echo '<option value="' . $ligne['idFournisseur'] . '">'
                                    ...
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="nbrTissu" type="text" class="form-control" id="placeholder"
                                            placeholder="Nombre Tissu" value="<?php if (isset($_POST['nbrTissu']))
                                                echo $_POST['nbrTissu'] ?>">
                                        </div>
                                        <div class="form-group" style="margin-top: 1rem;">
                                            <input name="nbrBouton" type="text" class="form-control" id="placeholder"
                                                placeholder="Nombre Bouton" value="<?php if (isset($_POST['nbrBouton']))
                                                echo $_POST['nbrBouton'] ?>">
                                        </div>
                                        <div class="form-group" style="margin-top: 1rem;">
                                            <input name="nbrFils" type="text" class="form-control" id="placeholder"
                                                placeholder="Nombre Fils" value="<?php if (isset($_POST['nbrFils']))
                                                echo $_POST['nbrFils'] ?>">
                                        </div>
                                        <div class="form-group" style="margin-top: 1rem;">
                                            <input name="autre" type="text" class="form-control" id="placeholder"
                                                placeholder="Autre" value="<?php if (isset($_POST['autre']))
                                                echo $_POST['autre'] ?>">
                                        </div>
                                    <?php { ?>
                                        <div class="form-group" style="margin-top: 1rem;">
                                            <input type="submit"
                                                ...
                                                value="Enregistrer"
                                                name="<?= isset($_GET['idm']) ? "modifier" : "enregistrer" ?>">
                                        </div>
                                    <?php } ?>
                                </form>
                            </div>
