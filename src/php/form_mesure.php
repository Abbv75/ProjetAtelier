                            ...
                            <div class="card-body">
                                ...
                                <form class="mt-4" action="http://localhost/projetatelier/src/php/connexion.php"
                                    ...
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="typeMesure" type="text" class="form-control" id="placeholder"
                                            placeholder="Type Mesure">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="epaule" type="text" class="form-control" id="placeholder"
                                            placeholder="Epaule">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="manche" type="text" class="form-control" id="placeholder"
                                            placeholder="Manche">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="poitrine" type="text" class="form-control" id="placeholder"
                                            placeholder="Poitrine">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="taille" type="text" class="form-control" id="placeholder"
                                            placeholder="Taille">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="cuisse" type="text" class="form-control" id="placeholder"
                                            placeholder="Cuisse">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="longueur" type="text" class="form-control" id="placeholder"
                                            placeholder="Longueur">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="fesse" type="text" class="form-control" id="placeholder"
                                            placeholder="Fesse">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="ceinture" type="text" class="form-control" id="placeholder"
