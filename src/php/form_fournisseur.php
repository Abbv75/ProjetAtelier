...
$pre = mysqli_real_escape_string($connect, $_POST['prenom']);
$adr = mysqli_real_escape_string($connect, $_POST['adresse']);
$tel = mysqli_real_escape_string($connect, $_POST['telephone']);
mysqli_query($connect, "INSERT INTO fournisseur(nom, prenom, adresse, telephone) 
VALUES ('" . $nom . "', '" . $pre . "', '" . $adr . "', '" . $tel . "')");
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Home</a>
                                    </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">Formulaire Fournisseur</h4>
                                <form class="mt-4" action="http://localhost/projetatelier/src/php/form_fournisseur.php"
                                    method="post">

                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="nom" type="text" class="form-control" id="placeholder"
                                            placeholder="Nom">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="prenom" type="text" class="form-control" id="placeholder"
                                            placeholder="Prenom">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="telephone" type="text" class="form-control" id="placeholder"
                                            placeholder="Telephone">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="adresse" type="text" class="form-control" id="placeholder"
                                            placeholder="Adresse">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <button type="button"
