                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Liste Commandes
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <table id="default_order"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button"
                                                        class="btn waves-effect waves-light btn-rounded btn-outline-secondary">Editer</button>
                                                    <button type="button"
                                                        class="btn waves-effect waves-light btn-rounded btn-outline-info">Terminer</button>
                                                    <button type="button"
                                                        class="btn waves-effect waves-light btn-rounded btn-outline-success">Livrer</button>
                                                    <button type="button"
