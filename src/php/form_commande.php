                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="mt-4" action="http://localhost/projetatelier/src/php/connexion.php"
                                    method="post">
                                    <div class=" form-group" style="margin-top: 1rem;">
                                        <input name="typeVetement" type="text" class="form-control" id="placeholder"
                                            placeholder="Type Vetement">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="idMode" type="text" class="form-control" id="placeholder"
                                            placeholder="Id Mode">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="idMesure" type="text" class="form-control" id="placeholder"
                                    ...
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="dateDepot" type="text" class="form-control" id="placeholder"
                                            placeholder="Date Depot">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <input name="dateLivraison" type="text" class="form-control" id="placeholder"
                                            placeholder="Date Livraison">
                                    </div>
                                    <div class="form-group" style="margin-top: 1rem;">
                                        <button type="button"
                                            class="btn waves-effect waves-light btn-rounded btn-primary">Enregistrer</button>
                                    </div>
                                </form>
                            </div>
                        </div>
