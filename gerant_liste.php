...
// Create a connection
$conn = $bd = new PDO("mysql:host=localhost;dbname=couturedb1", "root", "");
...
// SUPPRESSION
if (isset($_GET['ids'])) {
    $bd->query('delete from gerant where idGerant=' . $_GET['ids']);
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Liste Gerants</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Vues</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Liste Gerants</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center">GERANT</h4>
                                            ...
                                            <?php
                                                ...
                                                if ($result->rowCount() > 0) {
                                                    while ($row = $result->fetch()) {
                                                        ...
                                                        <td>".$row['adresse']."</td>
                                                        <td>
                                                            <button type='button' class='btn waves-effect waves-light btn-rounded btn-outline-secondary'>
                                                                <a href='gerant.php?idm=".$row['idGerant']."'>Editer</a>                                                        
                                                            </button>
                                                            <button type='button' class='btn waves-effect waves-light btn-rounded btn-outline-secondary'>
                                                                <a href='gerant_liste.php?ids=".$row['idGerant']."'>Supprimer</a>                                                                                                                        
                                                            </button>
                                                        </td>                                                      
                                                    </tr>";
                                                    }
