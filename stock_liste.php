...
// SUPPRESSION
if (isset($_GET['ids'])) {
    $conn->query('delete from stock where idStock=' . $_GET['ids']);
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Liste Stocks</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Vues</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Liste Stocks</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <table id="default_order"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nombre Bouton</th>
                                                <th>Nombre Fils</th>
                                                <th>Autre Accessoires</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php                                            
                                                $sql = "SELECT * FROM stock, fournisseur where stock.idFournisseur=fournisseur.idFournisseur";
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    <td>
                                                        <button type='button' class='btn waves-effect waves-light btn-rounded btn-outline-secondary'>
                                                            <a href='stock.php?idm=$row[idStock]'>Editer</a>                                                                                                                        
                                                        </button>
                                                        <button type='button' class='btn waves-effect waves-light btn-rounded btn-outline-secondary'>
                                                            <a href='stock_liste.php?ids=$row[idStock]'>Supprimer</a>                                                                                                                                                                                        
                                                        </button>
                                                    </td>                                                        
                                                    </tr>";
                                                    }
